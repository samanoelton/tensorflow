...
struct PJRT_Client_LoadFromExecutable_Args {
  size_t struct_size;
  PJRT_Extension_Base* extension_start;
  PJRT_Client* client;
...
PJRT_DEFINE_STRUCT_TRAITS(PJRT_Client_LoadFromExecutable_Args,
                          loaded_executable);

// Loads a PJRT_Executable.
typedef PJRT_Error* PJRT_Client_LoadFromExecutable(
    PJRT_Client_LoadFromExecutable_Args* args);
...
typedef struct PJRT_Api {
  ...
  _PJRT_API_STRUCT_FIELD(PJRT_Client_LoadFromExecutable);
} PJRT_Api;

enum {
  PJRT_Api_STRUCT_SIZE =
      PJRT_STRUCT_SIZE(PJRT_Api, PJRT_Client_LoadFromExecutable)
};
