...
PJRT_Error* PJRT_Client_LoadFromExecutable(
    PJRT_Client_LoadFromExecutable_Args* args) {
  PJRT_RETURN_IF_ERROR(ActualStructSizeIsGreaterOrEqual(
      "PJRT_Client_LoadFromExecutable_Args",
      PJRT_Client_LoadFromExecutable_Args_STRUCT_SIZE, args->struct_size));
...
PJRT_Api CreatePjrtApi(PJRT_Client_Create* create_fn,
  ...
  return PJRT_Api{
      ...
      /*PJRT_Client_LoadFromExecutable=*/pjrt::PJRT_Client_LoadFromExecutable,
  };
}
